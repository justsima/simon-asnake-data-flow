...
const Index = () => {
  useEffect(() => {
    ...
    document.body.classList.add('bg-[#170926]', 'text-white');
    ...
    return () => {
      ...
      document.body.classList.remove('bg-[#170926]', 'text-white', 'reduced-motion');
    };
  }, []);

  return (
    <div className="min-h-screen bg-[#170926]">
