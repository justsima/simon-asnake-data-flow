/*
  ...
  1. Sample Projects
    - Executive Sales Intelligence Dashboard (Power BI)
    - Customer Churn Prediction Model (Machine Learning)
    - Healthcare Claims ETL Pipeline (Data Engineering)

  2. Education & Certifications
    - Bachelor's degree and professional certifications
    - Mix of education and industry credentials

  3. Work Experience
    - Current and past positions with detailed responsibilities
    - Technologies and achievements for each role

  4. Skills & Expertise
    - Organized into categories with proficiency levels
    - Technical skills across data science domains

  5. Personal Information
    - Professional profile and contact details
...
(
  ...
  'Predictive inventory model with seasonal adjustments and ML algorithms optimizing stock levels across 50+ locations.',
  'Eliminating overstock while preventing stockouts across 50+ locations',
  'Created predictive inventory model with seasonal adjustments and machine learning algorithms to optimize stock levels based on historical sales patterns.',
  '18% reduction in carrying costs, 35% fewer stockouts, and improved cash flow by reducing unnecessary inventory investments.',
  ARRAY['Python', 'Power BI', 'Azure', 'SQL'],
  'Machine Learning',
  'https://app.powerbi.com/links/inventory-optimization',
  NULL
),
(
  'Marketing Campaign Analytics Platform',
  'End-to-end marketing analytics platform with custom attribution models tracking customer journey across digital channels.',
  'Marketing team needed advanced attribution modeling for digital campaigns',
  'Built end-to-end marketing analytics platform with custom attribution models to track customer journey touchpoints across channels.',
  '42% improvement in campaign ROI by optimizing channel mix based on analytical insights.',
  ARRAY['Python', 'R', 'Power BI', 'Google Analytics API'],
  'Machine Learning',
  NULL,
  'https://www.example.com/demos/marketing-analytics'
),
(
  'Supply Chain Visibility Dashboard',
  'Interactive Power BI dashboard integrating supplier, logistics, and inventory data with real-time alerts for potential disruptions.',
  'Global manufacturer lacked visibility into multi-tier supply chain',
  'Created interactive Power BI dashboard integrating supplier, logistics, and inventory data with real-time alerts for potential disruptions.',
  '28% reduction in stockouts, 15% improvement in on-time delivery, and $2.2M in savings from optimized inventory levels.',
  ARRAY['Power BI', 'DAX', 'Python', 'SQL'],
  'Power BI',
  'https://app.powerbi.com/links/supply-chain-dashboard',
  NULL
);
